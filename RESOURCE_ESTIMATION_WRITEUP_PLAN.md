...
- When discussing the lower-left direction of the plot, describe it as jointly
  reducing failure probability and space-time overhead.
...
3. Explain the overhead model for raw analog, EPS, STAR, and surface-code points.
4. Interpret the plotted tradeoff: raw has minimal overhead but poor coherence;
